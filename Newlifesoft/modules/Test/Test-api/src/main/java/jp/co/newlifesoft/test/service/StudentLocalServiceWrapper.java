...
package jp.co.newlifesoft.test.service;
...
public class StudentLocalServiceWrapper
	 ...
	 */
	@Override
	public jp.co.newlifesoft.test.model.Student addStudent(
		jp.co.newlifesoft.test.model.Student student) {
	 ...
	 */
	@Override
	public jp.co.newlifesoft.test.model.Student createStudent(long studentId) {
	 ...
	 */
	@Override
	public jp.co.newlifesoft.test.model.Student deleteStudent(long studentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public jp.co.newlifesoft.test.model.Student deleteStudent(
		jp.co.newlifesoft.test.model.Student student) {
	...
	@Override
	public jp.co.newlifesoft.test.model.Student fetchStudent(long studentId) {
	 ...
	 */
	@Override
	public jp.co.newlifesoft.test.model.Student getStudent(long studentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<jp.co.newlifesoft.test.model.Student> getStudents(
		int start, int end) {
	 ...
	 */
	@Override
	public jp.co.newlifesoft.test.model.Student updateStudent(
		jp.co.newlifesoft.test.model.Student student) {
