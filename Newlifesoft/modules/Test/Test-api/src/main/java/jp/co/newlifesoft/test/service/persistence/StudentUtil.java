...
package jp.co.newlifesoft.test.service.persistence;
...
public class StudentUtil {
	...
	public static Student remove(long studentId)
		throws jp.co.newlifesoft.test.exception.NoSuchStudentException {
